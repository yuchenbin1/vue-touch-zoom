  ...
  methods: {
    ...
    setTransform () {
      ...
      if (this.transformData.scale > 1) {
        ...
        console.log(this.$refs.touchZoom.offsetWidth)
        console.log(this.$refs.transformDom.offsetWidth)
        const minX = this.$refs.touchZoom.offsetWidth - (this.$refs.transformDom.offsetWidth * this.transformData.scale)
        const minY = this.$refs.touchZoom.offsetHeight - (this.$refs.transformDom.offsetHeight * this.transformData.scale)
        console.log('minX')
        console.log(minX)
        console.log('minY')
        console.log(minY)
        ...
        const maxX = this.$refs.touchZoom.offsetWidth - (this.$refs.transformDom.offsetWidth * this.transformData.scale)
        const maxY = this.$refs.touchZoom.offsetHeight - (this.$refs.transformDom.offsetHeight * this.transformData.scale)
